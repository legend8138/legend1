...
const JANO50 = new Discord.Client();const JANO = new Discord.Client();
const JANO2 = new Discord.Client();
const JANO3 = new Discord.Client();
const JANO4 = new Discord.Client();
const JANO5 = new Discord.Client();
...
MARS.login("NzU4MzU1MTE1MDM1NTkwNzE3.X2uzgg.8DItQ-aK3lXuXUAcb_UZiJ3tnnM");
MARS2.login("NzU4MzYwNjU2NzEzMzUxMjM5.X2u0nw.eTkf0ODTkZNBIuNkPavyvZgPDu0");
MARS3.login("NzU4MzY4NTYyOTQyODM2NzQ3.X2u1PA.9rXYixMrOUjxoBjwfmGkZvgzOQU");
MARS4.login("NzU4MzcwOTkwMDU2MDEzODM0.X2u10Q.ZtJAcxYv-KCRypp0tAfVJnU14SE");
MARS5.login("NzU4MzczODc3MTA4OTY1Mzc3.X2u2ZQ.QlvLrSHDwDqzQItxagLdQLHbiXs");
MARS6.login("NzU4Mzc1NTAyMjg4Mzg4MTM3.X2u3SA.FwljBWfv5v2d3gbmb5l84MOfFa4");
MARS7.login("NzU4Mzc2Mzk4ODk2MjM0NTU5.X2u46Q.9YNkLq5xym3hiJBLttlfux9YqrQ");
MARS8.login("NzU4MzgyMjc4ODM2NzQ4Mjk4.X2u6kA.weZh8OXSJKjWsHoEdDTlHxhc2xM");
MARS9.login("NzU4Mzg0MjQwNzQzNDE1ODU5.X2u7-g.LVn32DF4j-xPgNWPcBsrMFD2pKA");
MARS10.login("NzU4Mzg1NjIxMjk0NTE0MTg3.X2u9bg.7bM0GtPGZeXKMZbGZXQfKmrYmkQ");
MARS11.login("NzU4Mzg2MjU4NzExNjc0ODgx.X2u-VA.1Ur3_SsxFyBJ1v0a17fa4cQ811Q")
MARS12.login("NzU4Mzg3NTU3MzYwMjA1ODg1.X2u-2g.2zZkn9QNXTgNnmEgDWXP3jWenQQ");
MARS13.login("");
MARS14.login("");
MARS15.login("");
MARS16.login("");
...
MARS262.login("NzU4NDc0NzQ0MDYzMzI4MzA2.X25mOA.xhVA_JgY0gKJvFoy2nsAW8Xl9uk");

MARS263.login("NzU4NjQ0ODczODc5NjE3NTc2.X25mAw.sHPYVg6_OmiyHRTkj35YOUjjKR4");

MARS264.login("NzU4NjQ1NTAwNzIyNDEzNTY4.X25lrA.g0jgDbyDqRnTNbiG5c6VV4oavx4");

MARS265.login("NzU5MDM5NDU0ODY5OTc5MTY2.X25lKA.wLGJU-K-EiQNNt5XSZkcNa1XAq8");

MARS266.login("NzU5MDQwODUyMDg4ODQ4Mzk0.X25kiA.WPSdyYf0InTCa1uM0J8JlQzLGzQ");

MARS267.login("NzU5MDQxNjE0OTcwMjI0NzEw.X25kRg.nh9o7x7QFKlWHXRAwEayJBTCmbo");

MARS268.login("NzU5MDY1MDUwODAzMjA4MjAy.X25jig.WmoMrLtu7wPWqVdiBbCxQQ-9tzU");

MARS269.login("NzU5MDY3NTAxOTU0MjAzNzAz.X25jLA.WpGHTLX4gFzWOYi98sUafVw8Ai4");

MARS270.login("NzU5MDY4MjkyNDY2OTk5MzM3.X25ikQ.w7dng7eP6c5FruzEIuFuvOX99_Y");

MARS271.login("NzU5MDcwNTEwMDA0NTY4MDc1.X25iBw.sIykBT6JotwkzwfiA-Cq5WjyT3A")

MARS272.login("NzU5MDcyMDg0MDkyNzgwNjE3.X25hwg.Lm9gqdL3TJA-sPR9fFVYsApv3WM");

MARS273.login("NzU5MDcyNzg2MDY4NjY4NDU4.X25hZQ.hPaaeO10SQcXm04q7dTx3og56F4");

MARS274.login("NzU5MTAyOTc5MTU1Njg5NTAy.X25gsA.ZTGbHghgrRJhEFWXWxVdSNxP540");

MARS275.login("NzU5MTA0Mjc3ODY3NzkwMzQ4.X25fzA.GLaIpLEpHj61Fkba1BS7T7J2OtI");

MARS276.login("NzU5MTA0OTMyMDYxMjQ5NTg4.X25fNQ.gDNqheGtFnp5PrgUWtZl0GihAqs");

MARS277.login("NzU5MTA1NTA1MjQ2ODM4ODc0.X25e_g.BBC1Dt_UDcoGVRQcVMsg21QfSBs");

MARS278.login("NzU5MTA3MTk1NzE4ODYwODcz.X25eqA.SB9BJK-V8UDiY0a5lVElWrCqEwQ");

MARS279.login("NzU5MTA3ODIxOTg3MTY4Mjg2.X25dxQ.vGdfauIqPleSvT7q9lQC0sbY0Sk");

MARS280.login("NzU5MTA4NjE5ODAyNTA5MzYy.X25diQ.5K35JRpxOHVlXcEysgzzRNYSBm4");

MARS281.login("NzU5MTExNDQ2NzkzMDI3NjQ1.X25dTg.liAfSvXQStb8Eoophak15JVMCOs")

MARS282.login("NzU5MTEyMTQ2NDI4MTAwNjU4.X25dFg.wYtM4UEHgiAUSuJOacCmlEG-RvA");

MARS283.login("NzU5MTIyNDIzNzMxMzIyOTIw.X25c2g.MW8RTCY3XSFPaC3Clse9-aGkPo4");

MARS284.login("NzU5MTI0MDA1MjMxMDAxNjMw.X25cIw.F8XH4GQ_6Rpy3dXkbipj1iiwKfw");

MARS285.login("NzU5MTI2NzM5ODYyOTQ1Nzkz.X25b2A.FZyRcH6KA-rIyO9wIAmzcy6PONo");

MARS286.login("NzU5MTQ0MDkzNzA3Nzk2NTA1.X25aKw.dLLuU58mAj-YUpgf8bXDqSUEi_Q");

MARS287.login("NzU4Mzg5MDI1MjgyMzI2NTU4.X2vWxA.K5n7G3PHFxaVa5xTeiwJbIO_-X4");

MARS288.login("NzU4Mzg5NTMzNzY2MTg5MTA4.X2vWnw.pwq9P5iuMtsVd_-W3Y6ip6ZndEw");

MARS289.login("NzU4MzkwODU4ODM5MDk3NDQw.X2vWHg.kv7pruQg727ytj3tUlEWATUVjJg");

MARS290.login("NzU4MzkxMzcxNTU1NDA1ODQ0.X2vV1Q.45K-aLTcwTSfppYxe5uQUT9y1Xc");

MARS291.login("NzU4MzkyMDg3NTQ3ODcxMjYy.X2vVhg.hJ7v9Majf2A8WEgQy2NwSXHQRws")

MARS292.login("NzU4MzkzNzc3MzQ0NzQxMzc4.X2vVEg.5kHehS5vNoFQlzqeTVr1eO3sAxE");

MARS293.login("NzU4NDAwMzE3OTk2OTI0OTYw.X2vUog.TjG2YFEyRtsqNCJyw1K0ESugRTo");

MARS294.login("NzU4NDAxODkyNzU3MDEyNTEw.X2vUUw._tj3c7y_BWt6sr46c2mLiCgPusE");

MARS295.login("NzU4NDAzMTI0MDUzNTQwOTA0.X2vSsw.5TpQpPXiZkSF0uUiLV0cHWR845s");
MARS296.login("NzU4NDU3Mzc3Mzg0NjkzNzYw.X2vSIg.2Xmud-HptQbPmux0SMaVahOH_DA");

MARS297.login("NzU4NDAwMjI1MDA1Nzk3NDA5.X2uaPg.VrcDWYIn48C2zgOUuqEqeATzJF4");

MARS298.login("NzU4NDAyNDg2OTY0MzIyNDA1.X2uceQ.LeZ8VNTGYlEk_op252gBMn5jaIw");

MARS299.login("NzU4NDA0MzE3MjI4MzAyMzg2.X2udkw.huXbJ8ozAltGtFO9JiYYoUyMa4I");

MARS300.login("NzU4NDA1NDkyOTkyMjQ1Nzkw.X2ue5A.eREtCxfb_MDlcp6L4RkFhzfO2WM");
